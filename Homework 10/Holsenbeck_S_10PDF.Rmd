...
```
```{r,results='asis'}
stargazer::stargazer(RObs300sqFru, object.names = T,ci = T,single.row = T,star.char = c("<.1", "<.05", "<.01"),notes.append = F)
```

```{r,results='asis'}
stargazer::stargazer(RObs300Fru, object.names = T,ci = T,single.row = T,star.char = c("<.1", "<.05", "<.01"),notes.append = F)
```
...
```
```{r,results='asis'}
stargazer::stargazer(RObsFru0,RObsFru0intF0,RObsFru0intO0, object.names = T,ci = T,single.row = T,star.char = c("<.1", "<.05", "<.01"),notes.append = F)
```
```{r}
```
...
```
```{r,results='asis'}
stargazer::stargazer(Rep.AgeRacIncIde, object.names = T,ci = T,single.row = T,star.char = c("<.1", "<.05", "<.01"),notes.append = F)
```
...
```
```{r,results='asis'}
stargazer::stargazer(Repint.rWhAgeIncIde, object.names = T,ci = T,single.row = T,star.char = c("<.1", "<.05", "<.01"),notes.append = F)
```
```{r}
...
(Whodds <- predict.glm(Rep.AgeRacIncIde,input))
```
...
```
```{r,results='asis'}
stargazer::stargazer(Rep.AgeRacGenEduIncIdePid,Rep.AgeRacIncIde, object.names = T,ci = T,single.row = T,star.char = c("<.1", "<.05", "<.01"),notes.append = F)
```
```{r}
Rep.AgeRacGenEduIncIdePid$terms
