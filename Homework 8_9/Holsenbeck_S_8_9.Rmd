...
<br>
Referring back to the graphs, it appears that the two variables with the highest correlation are <u>wgtObs</u> and <u>conVeg</u>. To test:
```{r '11 - cont3'}
RObsVeg <- lm(R~wgtObs+conVeg,Pty_Hlth)
sjt.lm(RObsVeg)
```
