...
Pty_Sed <- left_join(Party,US14,by="ST")
```
...
<br>
The hypothesis is that states with higher proportions of conservatives will tend to have higher rates of people living sedentary lifestyles.
</div>
## 2
<div class="q">	Describe the data set you have found, including its source, its contents, and why it was collected originally.
</div>
<div class="a">
The data with proportion of the poulation living a lifestyle is a subset of the <a href="https://catalog.data.gov/dataset/nutrition-physical-activity-and-obesity-behavioral-risk-factor-surveillance-system" target="_blank">Nutrition, Physical Activity, and Obesity - Behavioral Risk Factor Surveillance System data set</a> from the CDC. 
</div>
## 3
